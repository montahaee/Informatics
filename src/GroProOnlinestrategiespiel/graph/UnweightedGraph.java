...
public class UnweightedGraph<V> implements Graph<V> {
    ...
    @Override /** Additions a vertex to the graph */
    ...
    @Override /** Additions an edge to the graph */
    ...
    public class SearchTree {
        ...
        public List<V> getMazePath(int index) {
...
//            if (path.indexOf(root) > neighbors)
            return path;
        }
