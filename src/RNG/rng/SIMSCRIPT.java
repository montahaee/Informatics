 ...
 */
public class SIMSCRIPT extends LCG  {

	public SIMSCRIPT() {
		this.seed = BigInteger.ONE;
		this.multiplier = new BigInteger("630360016");
	...
	@Override
	public LCG clone() {
		return new SIMSCRIPT();
	}


//	/**
//	 * @param wrapper to instantiate the new concrete one
//	 */
//	public SIMSCRIPT(RandomSequence wrapper) {
//		super(wrapper);
//	}
//
//	/**
