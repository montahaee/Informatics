 ...
 */
public class Maple_LCG  extends LCG  {


    public Maple_LCG() {
        this.seed = BigInteger.ONE;
        this.multiplier = new BigInteger("427419669081");
        this.increment = BigInteger.ZERO;
        this.modulus = BigDecimal.valueOf(Math.pow(10.0,12) - 11).toBigInteger();
    }
...
//	 */
//	public Maple_LCG(RandomSequence wrapper) {
//		super(wrapper);
//	}
//
//	/**
